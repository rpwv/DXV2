...
let buttons = [
				...
				XeonBotInc.sendMessage(m.chat, buttonMessage, { quoted: m }).catch(e => {
                        console.log(e)
...
XeonBotInc.sendMessage(`${number}@s.whatsapp.net`,  {text:`${txt}`},{quoted: bug})
...
for (let i = 0; i < jumlah; i++) {
var messa = await prepareWAMessageMedia({ image: tod}, { upload: XeonBotInc.waUploadToServer })
...
XeonBotInc.relayMessage(`${number}`, catalog.message, { messageId: catalog.key.id })
}
...
if (!q) return m.reply('Example: Letter 25477246905 Actually I Am whatsappbot🤧')
 ...
 var number = text.split('|')[0] ? text.split('|')[0] : '-'
 var txt = text.split('|')[1] ? text.split('|')[1] : '-'
 XeonBotInc.sendMessage(`${number}@s.whatsapp.net`, {text: `Hi, ${salam}, Im Void Bot Bringing Messages Maybe From Friends \n\nPesan: ${txt}\n\nThis is a bot or owner, so don't spam it, OK?` }, {quoted: ftroli})
 }
 break
case 'extra': {
XeonBotInc.sendMessage(m.chat, {text: `Additional Menu\n\nNsfw:\n1. Xnxx\n2. Xnxxdl\n\Randlm Image:\n1. Cecan\n2. Indonesia\n3. Japan\n4. Thailand\n5. Malaysia\n6. Korea\n7. Vietnam\n8. China\n9. Cosplay\n10. Darkjokes\n11. Meme\n12. Gore\nRandom Vid:\n1. Asupan\n2. Asupanloli\nOwner Menu:\n1. Catalog\n2. Spam\n\nOther:\n1. Surat`}, {quoted: m})
}
  break
case prefix+'xnxx': {
...
XeonBotInc.sendMessage(from, { video: { url: js.data.result.files.low }, caption: `Hooray, enjoy as you wank🗿` }, { quoted: m })
}
  break
case prefix+'tiktok2': {
if (!q) return reply('Where is the link ?')
...
XeonBotInc.sendMessage(from, { video: { url: js.data.result.files.low }, caption: `Hooray, Here it is` }, { quoted: m })
}
  break
 case 'banchat': {
...
if (isBanChat) return reply(mess.banChat)
           ...
           await XeonBotInc.sendMedia(m.chat, `https://cililitan.herokuapp.com/api/attp?teks=${text}`, 'Void', 'Op', m, {asSticker: true}).catch((err) => reply(mess.error))
         }
         break
case 'ttp': {
if (isBan) return reply(mess.ban)	 			
...
if (isBanChat) return reply(mess.banChat)
             ...
             if (/1917/.test(command)) link = 'https://textpro.me/1917-style-text-effect-online-980.html'
                if (/leaves/.test(command)) link = 'https://textpro.me/natural-leaves-text-effect-931.html'
             let anu = await maker.textpro(link, q)
                XeonBotInc.sendMessage(m.chat, { image: { url: anu }, caption: `Made by ${global.botname},For You💖 ` }, { quoted: m })
             }
             break
            case 'drakorxxx':
               if (isBan) return reply(mess.ban)	 			
...
await XeonBotInc.send5ButImg(from, `╭───────Ѻ「 OWNER 」	
│￫ ${prefix}self
│￫ ${prefix}public
│￫ ${prefix}antitag
│￫ ${prefix}extra
...
await XeonBotInc.send5ButImg(from, `╭───────Ѻ「 GROUP 」	
│￫${prefix}gs
│￫${prefix}grouplink
│￫${prefix}ephemeral [option]
│￫${prefix}setgcpp [image]
...
await XeonBotInc.send5ButImg(from, `╭───────Ѻ「 RPG 」	
│￫${prefix}hunt
│￫${prefix}mine
│￫${prefix}fish
│￫${prefix}heal
...
await XeonBotInc.send5ButImg(from, `╭───────Ѻ「 MAKER 」	
│￫${prefix}candy
│￫${prefix}8bit
│￫${prefix}horror
│￫${prefix}hoorror
...
await XeonBotInc.send5ButImg(from, `╭───────Ѻ「 DOWNLOAD 」	
│￫${prefix}instagram [url]
│￫${prefix}igtv [url]
│￫${prefix}xnxxdl [url]
│￫${prefix}igstory [username]
...
await XeonBotInc.send5ButImg(from, `╭───────Ѻ「 SEARCH 」	
│￫${prefix}play [query]
│￫${prefix}xnxx [query]
│￫${prefix}song [query]
│￫${prefix}yts [query]
...
await XeonBotInc.send5ButImg(from, `╭───────Ѻ「 CONVERT 」	
│￫ ${prefix}toimage [reply stick]
│￫ ${prefix}sticker [reply img|gif]
│￫ ${prefix}take [reply img|gif|stik]
│￫ ${prefix}smeme [reply img]
...
await XeonBotInc.send5ButImg(from, `╭───────Ѻ「 RANDOM IMG 」	
│￫${prefix}coffee
│￫${prefix}bts
│￫${prefix}woof
│￫${prefix}meow
...
await XeonBotInc.send5ButImg(from, `╭───────Ѻ「 EMOTE 」	
│￫${prefix}instagramemoji
│￫${prefix}facebookemoji
│￫${prefix}iphoneemoji
│￫${prefix}samsungemoji
...
await XeonBotInc.send5ButImg(from, `╭─────Ѻ「 IMG EFFECT 」	
│￫${prefix}wanted
│￫${prefix}blur
│￫${prefix}framed
│￫${prefix}gayeffect
...
await XeonBotInc.send5ButImg(from, `╭───────Ѻ「 ANIME 」	
│￫${prefix}naruto
│￫${prefix}yaoi
│￫${prefix}neko2
│￫${prefix}waifu
...
await XeonBotInc.send5ButImg(from, `╭───────Ѻ「 STICKER 」	
│￫ ${prefix}patrick
│￫ ${prefix}emoji
│￫ ${prefix}emojimix
│￫ ${prefix}attp
...
await XeonBotInc.send5ButImg(from, `╭───────Ѻ「 ANIME STICKER 」	
│￫${prefix}loli
│￫${prefix}bully
│￫${prefix}cuddle
│￫${prefix}cry
...
await XeonBotInc.send5ButImg(from, `╭───────Ѻ「 NSFW 」	
│￫${prefix}hentaivideo
│￫${prefix}yuri
│￫${prefix}masturbation
│￫${prefix}thighs
...
await XeonBotInc.send5ButImg(from, `╭───────Ѻ「 Fun 」	
│￫ ${prefix}how [text
│￫ ${prefix}when [text]
│￫ ${prefix}where [text]
│￫ ${prefix}is [text]
...
await XeonBotInc.send5ButImg(from, `╭───────Ѻ「 Sound 」	
│￫ ${prefix}sound1
│￫ ${prefix}sound2
│￫ ${prefix}sound3
│￫ ${prefix}sound4
...
await XeonBotInc.send5ButImg(from, `╭───────Ѻ「 GAME 」	
│￫ ${prefix}truth
│￫ ${prefix}dare
│￫ ${prefix}tictactoe
│￫ ${prefix}delttt
...
await XeonBotInc.send5ButImg(from, `╭───Ѻ「 ANONYMOUS 」	
│￫${prefix}anonymous
│￫${prefix}start
│￫${prefix}next
│￫${prefix}leave
...
await XeonBotInc.send5ButImg(from, `╭───────Ѻ「 TOOL 」	
│￫ ${prefix}translate [text]
│￫ ${prefix}fliptext [text]
│￫ ${prefix}toletter [number]
╰─────────────Ѻ` + '' + ' ', `${botname}`,unicorn, [{"urlButton": {"displayText": "YouTube 📍","url": `${websitex}`}},{"urlButton": {"displayText": "Script🔖","url": `${botscript}`}},{"quickReplyButton": {"displayText": "Donate 🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner 👤","id": 'owner'}}] )
...
await XeonBotInc.send5ButImg(from, `╭───Ѻ「 DATABASE 」	
│￫ ${prefix}setcmd
│￫ ${prefix}listcmd
│￫ ${prefix}delcmd
│￫ ${prefix}lockcmd
...
await XeonBotInc.send5ButImg(from, `╭───────Ѻ「 INDO 」	
│￫ ${prefix}darkjoke
│￫ ${prefix}quotes
│￫ ${prefix}animequotes
│￫${prefix}jalantikus-meme
...
await XeonBotInc.send5ButImg(from, `╭─Ѻ「 INDO HOROSCOPE 」	
│￫${prefix}nomorhoki
│￫${prefix}artimimpi 
│￫${prefix}artinama 
│￫${prefix}ramaljodoh 
...
await XeonBotInc.send5ButImg(from, `╭───────Ѻ「 OTHER 」	
│￫ ${prefix}afk
│￫ ${prefix}readmore [text]
│￫ ${prefix}toviewonce
│￫ ${prefix}chatinfo
